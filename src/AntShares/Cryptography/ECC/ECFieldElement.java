...
public class ECFieldElement implements Comparable<ECFieldElement>
{
    BigInteger Value;
    ECCurve curve;
    ...
    static BigInteger[] FastLucasSequence(BigInteger p, BigInteger P, BigInteger Q, BigInteger k)
    {
